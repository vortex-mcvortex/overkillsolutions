...
const DEFAULT_SETTINGS = {
  ...
  defaultMaterialPriceMode: "msrp",
  monthlyOverheadEstimate: 0,
  laborCostPerHour: 20,
  machineMaintenanceReservePercent: 5,
  machineDepreciationReservePercent: 5,
      ...
      <div className="settings-grid">
        <div className="form-card">
          ...
          <div className="form-grid">
            ...
            <Field label="Quote Expiration Days" value={settings.quoteExpirationDays || 30} onChange={(value) => update("quoteExpirationDays", value)} />
            <Field label="Target Profit Margin %" value={settings.targetProfitMarginPercent || 35} onChange={(value) => update("targetProfitMarginPercent", value)} />
          </div>
        ...
        <div className="form-card">
          <h3 className="card-title">Financial / True-Cost Defaults</h3>
          <p className="muted-text">Used for business intelligence, true hourly cost modeling, and profitability planning.</p>

          <div className="form-grid single-row-gap">
            <Field label="Monthly Overhead Estimate" value={settings.monthlyOverheadEstimate || 0} onChange={(value) => update("monthlyOverheadEstimate", value)} />
            <Field label="Labor Cost Per Hour" value={settings.laborCostPerHour || 20} onChange={(value) => update("laborCostPerHour", value)} />
            <Field label="Maintenance Reserve %" value={settings.machineMaintenanceReservePercent || 5} onChange={(value) => update("machineMaintenanceReservePercent", value)} />
            <Field label="Depreciation Reserve %" value={settings.machineDepreciationReservePercent || 5} onChange={(value) => update("machineDepreciationReservePercent", value)} />
          </div>

          <label className="field single-row-gap">
            <span>Default Catalog Pricing Mode</span>
            <select value={settings.defaultMaterialPriceMode || "msrp"} onChange={(event) => update("defaultMaterialPriceMode", event.target.value)}>
